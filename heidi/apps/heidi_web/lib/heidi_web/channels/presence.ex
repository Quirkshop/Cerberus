defmodule BroadcastWeb.Presence do
  @moduledoc """
  ...
  Presences can be tracked in your channel after joining:
      ...
      defmodule BroadcastWeb.MyChannel do
        use BroadcastWebWeb, :channel
        alias BroadcastWebWeb.Presence
  ...
  """
  use Phoenix.Presence, otp_app: :heidi_web,
                        pubsub_server: BroadcastWeb.PubSub
end
